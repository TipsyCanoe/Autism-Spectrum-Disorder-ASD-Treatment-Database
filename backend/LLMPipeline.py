...
class LLMPipeline:
    ...
    def step4_download_results(self, batch_id=None):
        ...
        with open('outputs.jsonl', 'wb') as f:
            f.write(file_response.content)
        
        print(f"Results saved to outputs.jsonl")
        return 'outputs.jsonl'
    
    def step5_convert_to_csv(self, input_file='outputs.jsonl'):
        ...
        return 'extracted_papers.csv'
    
    def step6_create_vectors(self, input_csv='extracted_papers.csv', 
